...
function ProductBuyTogetherCard(product: Product) {
  ...
  return (
    <div class="lg:p-3 lg:w-[23rem] font-quicksand flex gap-3 rounded-[0.625rem] border border-[#e5e5e5] shadow-[0_0.125rem_0.125rem_rgba(0,0,0,0.16)] items-center">
      <div class="lg:w-[35%]">
...
function BuyTogether({
  ...
  return (
    <section class="lg:py-6">
      <div>
        <h3 class="lg:text-[1.75rem] leading-[2.1875rem] text-primary font-semibold tracking-normal my-5 text-left">
          Compre junto
        </h3>
