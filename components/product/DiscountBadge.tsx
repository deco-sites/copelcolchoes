...
function DiscountBadge({ price, listPrice, className }: Props) {
  ...
  return (
    <div
      class={`pointer-events-none absolute top-[1.375rem] bg-black text-left font-bold z-[1] py-1 px-2 max-lg:py-[0.1875rem] max-lg:px-[0.3125rem] max-lg:top-[1.5624rem] ${className}`}
    >
