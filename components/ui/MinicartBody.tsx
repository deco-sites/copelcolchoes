...
function MinicartBody() {
  ...
  return (
    <>
      <div>
        ...
        <Picture class={`flex flex-col items-center`}>
          ...
          {imagesBody.desktop.src.map((img) => {
            ...
            const categoryFormat = categoryArray.map((category) =>
              category.replace(".png", "")
            );
            ...
            return (
              <a
                href={`/${category}`}
                class={clx(
                  `w-[333px] h-[130.588px] md:w-[334px] md:h-[120px] overflow-hidden rounded-[21.765px] 
              ...
              >
                ...
                <span
                  class={clx(`absolute uppercase text-[#ffffff] text-[24px] 
                                        md:text-[26px] leading-[45.706px] font-black font-quicksand`)}
                >
                  {category}
                </span>
              </a>
      ...
      <p
        class={`text-primary text-[18px] leading-[42px] font-bold font-quicksand text-center`}
      >
        Ou
      </p>
      <div>
        <a
          class={clx(
            `bg-primary rounded-[5px] text-white font-quicksand text-base font-black h-12 tracking-normal cursor-pointer
