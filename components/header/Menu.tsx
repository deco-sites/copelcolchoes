      ...
      item.variant === "AllCategories"
        ? (
          <div class="collapse collapse-plus relative items-start border-[#C5C6CB] border-b rounded-none">
            ...
            <div
              class={clx(
                `collapse-title min-h-0 p-0 font-comfortaa py-2.5 font-dm-sans font-bold text-sm px-0 
            ...
            <div class="collapse-content px-0">
              <ul class="border-t border-base-content border-solid pt-0 px-0 pl-5">
                {item.children?.map((node) => {
                  const url_all = node.children && node.children[0].href
                    ? node.children[0].href.split("/")
                    : null;
                  ...
                  return (
                    <li class="">
                      <div class="collapse collapse-plus relative items-start">
                        ...
                        <div
                          class={clx(
                            `collapse-title min-h-0 p-0 py-2.5 font-dm-sans font-normal text-sm px-0 font-comfortaa
                         flex items-center justify-between after:!text-[20px]`,
                          )}
                        >
                          {node.label}
    ...
    : (
      <a
        ...
        class={`w-full block py-2.5 font-dm-sans text-sm ${
          item.highlighted
            ? "text-secondary flex items-center leading-[18.2px] font-bold"
            : "font-normal"
        }`}
      >
        {item.highlighted && (
    ...
    <div class="flex flex-col justify-center pb-3 h-full">
      <div class="w-full flex items-center justify-between py-4 pb-2 px-4">
        <a
          href="/my-account"
          class={clx(
            `flex items-center justify-start gap-1 uppercase text-base-content font-comfortaa leading-[18.2px] text-[14px] font-bold tracking-[1px]`,
          )}
        >
      ...
      <div
        class={clx(
          `px-4 gap-y-[10px] py-[0] flex flex-col justify-center items-center`,
        )}
      >
        <a
          href="/my-account"
          class={clx(
            `text-[12px] leading-[15.6px] text-[#fff] font-comfortaa py-[8px] px-[20px] rounded-[5px] bg-primary w-full font-bold text-center`,
          )}
        >
          Meus dados
        </a>
        <a
          href="/my-account"
          class={clx(
            `text-[12px] leading-[15.6px] text-primary font-comfortaa py-[8px] px-[20px] rounded-[5px] border border-primary font-bold w-full text-center`,
          )}
        >
          Meus pedidos
        </a>
        ...
        {user.value?.email && (
          <a
            href={`/api/vtexid/pub/logout?scope=copelcolchoes&returnUrl=https://www.copelcolchoes.com.br`}
            class={clx(
              `text-[12px] leading-[15.6px] text-primary font-comfortaa py-[8px] px-[20px] rounded-[5px] border border-primary font-bold w-full text-center`,
            )}
          >
      ...
      >
        ...
        <span class="tracking-[1px] text-sm font-bold font-comfortaa mr-[8px]">
          Televendas:
        </span>
        <span class="tracking-[1px] text-sm font-normal font-quicksand">
          (11) 2109-9109
        </span>
      </a>
      <a
      ...
      >
        ...
        <span class="tracking-[1px] text-sm md:text-xs font-bold font-comfortaa">
          Fale conosco
        </span>
      </a>
    </div>
